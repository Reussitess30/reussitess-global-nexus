module.exports = {
  ...
  questions: [
    ...
    {
      question: "Question exemplaire #1 sur Personnalités ?",
      answers: ["choix 1", "choix 2", "choix 3"],
      correct: 0,
      explanation: "Explication positive #1."
    },
    {
      question: "Question exemplaire #2 sur Personnalités ?",
      answers: ["choix 1", "choix 2", "choix 3"],
      correct: 2,
  ...
  tips: [
    ...
    "Dans Personnalités, chaque jour est une occasion de s’enrichir."
  ]
};
