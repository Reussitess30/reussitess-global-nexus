...
export default function Home() {
  ...
  const quizCategories = [
    ...
    { id: "Tech", title: "Tech", color: "from-blue-500 to-cyan-400" },
    { id: "Excellence971", title: "🌴 REUSSITESS® 971", color: "from-orange-500 via-red-600 to-yellow-400" }, { id: "Excellence971", title: "🌴 Excellence 971", color: "from-yellow-500 to-red-600", name: "Technologie", icon: "💻", color: "#00b894" },
